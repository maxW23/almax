...
class ZegoRoomLoginNotifier {
  ...
  void _checkExpressRoom() {
    ...
    // debugAppLogger.debug('login notifier($_targetRoomID), check express(${expressService.currentRoomID}), '
    //     'result:$_result, ');
  ...
  void _onExpressRoomStateChanged(ZegoRoomStateEvent event) {
    ...
    // debugAppLogger.debug('login notifier($_targetRoomID), express(${expressService.currentRoomID}), '
    //     'result:$_result, '
    //     'event:$event, ');
  ...
  void _checkZIMRoom() {
    ...
    // debugAppLogger.debug('login notifier($_targetRoomID), check zim(${zimService.currentRoomID}), '
    //     'result:$_result, ');
  ...
  void _onZIMRoomStateChanged(
    ...
    // debugAppLogger.debug('login notifier($_targetRoomID), zim(${zimService.currentRoomID}), '
    //     'result:$_result, '
    //     'event:$event, ');
