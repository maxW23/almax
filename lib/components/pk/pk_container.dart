...
class _ZegoPKContainerViewState extends State<ZegoPKContainerView> {
  ...
  void initState() {
    ...
    subscriptions.addAll([
      ...
      widget.liveStreamingManager.onPKBattleUserQuitCtrl.stream
          .listen(onPKUserQuit),
      widget.liveStreamingManager.onPKBattleUserUpdateCtrl.stream
    ...
    for (final pkUser
      ...
      final positioned = Positioned(
          ...
          child: Container(
            width: newRect.right - newRect.left,
            height: newRect.bottom - newRect.top,
            color: pkUser.userID == ZEGOSDKManager().currentUser!.iduser
                ? Colors.yellow
                : Colors.blue,
            child: PKView(
              pkUser: pkUser,
