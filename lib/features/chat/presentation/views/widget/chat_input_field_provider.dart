...
//   final Function(String? audioMessage, bool cancel) handleRecord;
//   final VoidCallback onSlideToCancelRecord;

//   /// function to handle the selected image
//   final Function(String? imageMessage) handleImageSelect;
...
//       // final textMessage =MessagePrivate(message: textController.text ,)
...
//           AppLogger.debug('rawTime $value ${StopWatchTimer.getDisplayTime(_recordTime)}');
//           notifyListeners();
//         });
...
//   String? _getImageMEssageFromPath(String? path) {
//     if (path != null) {
