...
class WeeklyTimerStripPoints extends StatefulWidget {
  const WeeklyTimerStripPoints({super.key});

  @override
  State<WeeklyTimerStripPoints> createState() => _WeeklyTimerStripPointsState();
}

class _WeeklyTimerStripPointsState extends State<WeeklyTimerStripPoints> {
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            // List for weekly users 1..10 with weekly and monthly points
            Positioned(
              top: 280,
              right: 0,
              left: 0,
                    ...
                    builder: (context, state) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final weekPts = (u.totalSpent ?? '').trim();
                          return Container(
                                height: 48.h,
