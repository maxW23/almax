...
class ZegoCallManager implements ZegoCallManagerInterface {
  ...
  Future<ZIMCallInvitationSentResult> sendUserRequest(
    ...
    if (sucessUsers.isNotEmpty) {
      currentCallData!
        ...
        ..inviter = CallUserInfo(userID: localUser?.iduser ?? '')
  ...
  Future<ZIMCallAcceptanceSentResult> acceptCallInvitation(
    ...
    final extendedData = getCallExtendata(
  ...
  String getMainStreamID() {
    return '${ZEGOSDKManager().expressService.currentRoomID}_${ZEGOSDKManager().currentUser!.iduser}_main';
  }
