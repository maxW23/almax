// import 'package:lklk/core/widgets/top_bar_rooms.dart';
...
//     topBarRoomSVGAElements[0].linkPath!,
//     // giftsSVGAElements[0].linkPath!,
//     // giftsSVGAElements[1].linkPath!,
//     // giftsSVGAElements[2].linkPath!,
//     // giftsSVGAElements[3].linkPath!,
//     // giftsSVGAElements[4].linkPath!,
//     // giftsSVGAElements[5].linkPath!,
//     // giftsSVGAElements[6].linkPath!,
//     // giftsSVGAElements[7].linkPath!,
//     // giftsSVGAElements[8].linkPath!,
//     // giftsSVGAElements[9].linkPath!,
//     // giftsSVGAElements[10].linkPath!,
//     // giftsSVGAElements[11].linkPath!,
//     // giftsSVGAElements[12].linkPath!,
...
//     //       Paint()..color = const Color(0xFFFF0000)); // draw by yourself.
//     // }, "banner"),
//   };
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: const AutoSizeText('SVGA Flutter Samples')),
//       body: ListView.separated(
//           itemCount: samples.length,
//           separatorBuilder: (_, __) => const Divider(),
//           itemBuilder: (context, index) {
//             return ListTile(
//                 title: AutoSizeText(samples[index].first),
//                 subtitle: AutoSizeText(samples[index].last),
...
//       {super.key, required this.image, this.name, this.dynamicCallback});
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: AutoSizeText(widget.name ?? "")),
//       body: Stack(
//         children: <Widget>[
//           Container(
//               padding: const EdgeInsets.all(8.0),
//               child: AutoSizeText("Url: ${widget.image}",
...
//               label: AutoSizeText(animationController!.isAnimating ? "Pause" : "Play"),
...
//                 label: AutoSizeText(hideOptions ? 'Show options' : 'Hide options')),
//             AnimatedBuilder(
...
//                 children: [
//                   const AutoSizeText('Image filter quality'),
...
//                         value: value,
//                         child: AutoSizeText(value.toString().split('.').last),
//                       );
//                     }).toList(),
//                   )
//                 ],
...
//                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                 children: [
//                   const AutoSizeText('Allow drawing overflow'),
...
//                 ],
//               ),
//               const AutoSizeText('Container options:'),
//               Row(
//                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                 children: [
//                   const AutoSizeText(' width:'),
//                   Slider(
//                     min: 100,
