...
// class AlphaPlayerPage extends StatefulWidget {
//   const AlphaPlayerPage();

//   @override
//   State<AlphaPlayerPage> createState() => _AlphaPlayerPageState();
// }

// class _AlphaPlayerPageState extends State<AlphaPlayerPage> {
...
//                     CupertinoButton(
//                       color: Colors.purple,
//                       child: AutoSizeText("播放demo_play.mp4"),
//                       onPressed: () async {
...
//                     CupertinoButton(
//                       color: Colors.purple,
//                       child: AutoSizeText("播放assets demo1.mp4"),
//                       onPressed: () {
//                         if (Platform.isAndroid) { /// 安卓路径读取方式
//                           AlphaPlayerController.playVideo("/assets/gifts/", "demo.mp4");
//                         } else if (Platform.isIOS) { /// iOS 路径读取方式
//                           /// iOS 由于基于字节播放器的二次封装，内部需要解析config.json 文件来读取资源，所以，视频同级目录内都要有一个对应的config.json文件
//                           /// assets 文件夹，也可替换为自定义的文件夹
//                           AlphaPlayerController.playAssetVideo("assets/gifts/", "demo1.mp4");
//                         }
//                       },
//                     ),
//                     CupertinoButton(
//                       color: Colors.purple,
//                       child: AutoSizeText("attachView"),
//                       onPressed: () {
...
//                     CupertinoButton(
//                       color: Colors.purple,
//                       child: AutoSizeText("releasePlayer"),
//                       onPressed: () {
