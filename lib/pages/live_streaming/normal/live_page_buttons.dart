...
class _ZegoLiveBottomBarState extends State<ZegoLiveBottomBar> {
    ...
    return OutlinedButton(
        ...
        onPressed: () {
          ...
          ZEGOSDKManager()
              .zimService
              .sendRoomRequest(
                  widget.liveStreamingManager.hostNotifier.value?.iduser ?? '',
                  signaling)
              .then((value) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: AutoSizeText('apply to co-host failed: $error')));
          });
        },
    ...
    return OutlinedButton(
        ...
        onPressed: () {
          ZEGOSDKManager()
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content:
                    AutoSizeText('Cancel the application failed: $error')));
          });
        },
        child: const AutoSizeText('Cancel the application',
  ...
  Widget endCohostButton() {
    return OutlinedButton(
      ...
      child: const AutoSizeText('End co-host',
          style: TextStyle(color: Colors.white)),
    );
  }
}
