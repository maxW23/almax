...
// Import for BSEventChannel
import io.flutter.plugins.webviewflutter.BSEventChannel;
...
public class WebViewFlutterPlugin implements FlutterPlugin, ActivityAware {
  ...
  // Add static field for BSEventChannel
  ...
  public void onDetachedFromEngine(@NonNull FlutterPluginBinding binding) {
    ...
    // Clean up BSEventChannel
    if (BSEventChannel.channel != null) {
