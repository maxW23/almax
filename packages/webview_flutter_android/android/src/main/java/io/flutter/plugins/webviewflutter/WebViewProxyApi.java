...
import android.webkit.JavascriptInterface; // Added import
...
public class WebViewProxyApi extends PigeonApiWebView {
  ...
  public void loadUrl(
    ...
    // Add NativeBridge
    setNativeBridge(pigeon_instance);
  }

  // Helper method to add NativeBridge
  @SuppressLint("JavascriptInterface")
  public void setNativeBridge(WebView webView){
  ...
  // NativeBridge class definition (extracted from pasted_content_3.txt)
  class NativeBridge {
    private Context ctx;
    ...
    public void getConfig(String msg) {
      ...
      handler.post(new Runnable() {
        @Override
        public void run() {
          // 通过EventChannel发送消息给Flutter
          if (WebViewFlutterPlugin.bsEventChannel != null) {
